...
public class ResourcePropertiesAction extends ResourceAction {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (selectedResources.length > 0) {
      ...
      GanttDialogPerson dp = new GanttDialogPerson(myProject.getResourceCustomPropertyManager(), myProject.getTaskManager(), myProject.getAssignmentManager(), myUIFacade,
          selectedResources[0]);
      dp.setVisible(true);
      if (dp.result()) {
