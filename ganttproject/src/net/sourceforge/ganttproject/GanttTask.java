...
public class GanttTask extends TaskImpl implements Serializable {
   ...
   *          unique one.
   */
  public GanttTask(String name, GanttCalendar start, long length, TaskManagerImpl taskManager, AssignmentManager assignmentManager, int taskID) {
    super(taskManager, assignmentManager, taskID);
